...
# ================================IMAGES========================================
blank_img = PhotoImage(file="D:/last/rock_paper_scissors/images/blank.png")
player_rock = PhotoImage(file="D:/last/rock_paper_scissors/images/player_rock.png")
sm_player_rock = player_rock.subsample(3, 3)


player_paper = PhotoImage(file="D:/last/rock_paper_scissors/images/player_paper.png")
sm_player_paper = player_paper.subsample(3, 3)
player_scissor = PhotoImage(file="D:/last/rock_paper_scissors/images/player_scissor.png")
sm_player_scissor = player_scissor.subsample(3, 3)
com_rock = PhotoImage(file="D:/last/rock_paper_scissors/images/com_rock.png")
com_paper = PhotoImage(file="D:/last/rock_paper_scissors/images/com_paper.png")
com_scissor = PhotoImage(file="D:/last/rock_paper_scissors/images/com_scissor.png")
...
def Rock():
    ...
    play_sound("D:/last/rock_paper_scissors/sounds/click.wav")
    MatchProcess()
...
def ComputerRock():
    ...
    if player_choice == 1:
        ...
        play_sound("D:/last/rock_paper_scissors/sounds/tie.wav")
        ...
        play_sound("D:/last/rock_paper_scissors/sounds/win.wav")
        ...
        play_sound("D:/last/rock_paper_scissors/sounds/lose.wav")
